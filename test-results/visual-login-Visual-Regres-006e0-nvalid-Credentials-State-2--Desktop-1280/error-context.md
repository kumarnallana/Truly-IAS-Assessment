...
- Name: visual\login.spec.js >> Visual Regression - Login Flow >> Login Invalid Credentials (State 2)
- Location: tests\regression\visual\login.spec.js:16:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  Snapshot: login-state-2-invalid.png

Call log:
  - Expect "toHaveScreenshot(login-state-2-invalid.png)" with timeout 5000ms
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    ...
    - region [ref=e8]:
      ...
      - alert [ref=e12]: Invalid email or password. Please try again.
      - generic [ref=e13]:
        - textbox "Email or Username" [ref=e15]: invalid@email.com
        - generic [ref=e17]:
          - textbox "••••••••••••" [ref=e18]: wrongpassword
      ...
      - generic [ref=e28]:
        - text: New here?
        - link "Create an account" [ref=e29] [cursor=pointer]:
          - /url: /index.html
