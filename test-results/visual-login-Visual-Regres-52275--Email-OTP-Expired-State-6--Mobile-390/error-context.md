...
- Name: visual\login.spec.js >> Visual Regression - Login Flow >> Email OTP Expired (State 6)
- Location: tests\regression\visual\login.spec.js:45:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  18996 pixels (ratio 0.06 of all image pixels) are different.

  Snapshot: login-state-6-otp-expired.png

Call log:
  - Expect "toHaveScreenshot(login-state-6-otp-expired.png)" with timeout 5000ms
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - region [ref=e7]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]: ✉️
          - heading "Email Verification" [level=1] [ref=e11]
          - paragraph [ref=e12]:
            - text: Enter the 6-digit code sent to
            - strong [ref=e13]: your email
        - alert [ref=e14]: Code expired.
        - generic [ref=e15]:
          - group "6-digit verification code" [ref=e16]:
            - textbox "Digit 1" [ref=e17]
            - textbox "Digit 2" [ref=e18]
            - textbox "Digit 3" [ref=e19]
            - textbox "Digit 4" [ref=e20]
            - textbox "Digit 5" [ref=e21]
            - textbox "Digit 6" [ref=e22]
          - button "Verify code" [ref=e23]
        - generic [ref=e24]:
          - paragraph [ref=e25]: You can request a new code in 00:28
          - button "Resend New Code" [ref=e26] [cursor=pointer]
          - paragraph [ref=e27]:
            - text: Didn't receive the code?
            - button "Resend code (00:25)" [ref=e28] [cursor=pointer]
  - generic [ref=e29]:
    ...
    - button [disabled] [ref=e39] [cursor=pointer]
    - button "0" [ref=e40] [cursor=pointer]
    - button "Backspace" [ref=e41] [cursor=pointer]: ⌫
  - contentinfo [ref=e42]: © 2026 SecureID. All rights reserved.
```
