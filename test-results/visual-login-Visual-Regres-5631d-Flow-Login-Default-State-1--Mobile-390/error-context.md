...
- Name: visual\login.spec.js >> Visual Regression - Login Flow >> Login Default (State 1)
- Location: tests\regression\visual\login.spec.js:7:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  38484 pixels (ratio 0.12 of all image pixels) are different.

  Snapshot: login-state-1-default.png

Call log:
  - Expect "toHaveScreenshot(login-state-1-default.png)" with timeout 5000ms
