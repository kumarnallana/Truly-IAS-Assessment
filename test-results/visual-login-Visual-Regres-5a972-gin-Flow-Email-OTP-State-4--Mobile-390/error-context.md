...
- Name: visual\login.spec.js >> Visual Regression - Login Flow >> Email OTP (State 4)
- Location: tests\regression\visual\login.spec.js:33:3
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  5618 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: login-state-4-otp.png

Call log:
  - Expect "toHaveScreenshot(login-state-4-otp.png)" with timeout 5000ms
  ...
  - main [ref=e2]:
    - generic [ref=e3]:
      ...
      - region [ref=e7]:
        ...
        - generic [ref=e14]:
          - group "6-digit verification code" [ref=e15]:
            - textbox "Digit 1" [ref=e16]: "4"
            - textbox "Digit 2" [ref=e17]: "8"
            - textbox "Digit 3" [ref=e18]: "2"
            - textbox "Digit 4" [ref=e19]: "9"
            - textbox "Digit 5" [ref=e20]: "1"
            - textbox "Digit 6" [ref=e21]: "3"
          - button "Verify code" [ref=e22]
        - generic [ref=e23]:
          - paragraph [ref=e24]:
            - text: Code expires in
            - strong [ref=e25]: 02:45
          - paragraph [ref=e26]:
            - text: Didn't receive the code?
            - button "Resend code (00:25)" [ref=e27] [cursor=pointer]
  - generic [ref=e28]:
    ...
    - button "Backspace" [ref=e40] [cursor=pointer]: ⌫
  - contentinfo [ref=e41]: © 2026 SecureID. All rights reserved.
```
