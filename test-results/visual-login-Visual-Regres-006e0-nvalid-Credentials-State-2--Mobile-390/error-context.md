...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  36294 pixels (ratio 0.12 of all image pixels) are different.
    ...
    - generic [ref=e3]:
      ...
      - region [ref=e7]:
        - generic [ref=e8]:
          ...
          - paragraph [ref=e10]: Login to your account
        - alert [ref=e11]: Invalid email or password. Please try again.
        - generic [ref=e12]:
          - textbox "Email or Username" [ref=e14]: invalid@email.com
          - generic [ref=e16]:
            - textbox "••••••••••••" [ref=e17]: wrongpassword
